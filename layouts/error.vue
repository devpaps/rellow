  ...
  created() {
    if (process.client) {
      window.onNuxtReady((app) => {
        ...
        TweenMax.to('.box', 2, {opacity: 1, scale: 1, ease: Elastic.easeOut.config(1, 0.5)});
...
h1
      font-size: calc(32px + (80 - 40) * ((100vw - 300px) / (1600 - 300)))
